...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('users') && ! Schema::hasColumn('users', 'business_role')) {
        ...
        if (! Schema::hasTable('rooms_chairs')) {
        ...
        if (! Schema::hasTable('mpesa_transactions')) {
            Schema::create('mpesa_transactions', function (Blueprint $table) {
                ...
                $table->index(['business_id', 'payment_status', 'transaction_time'], 'mpesa_tx_biz_status_time_idx');
            });
        } elseif (! Schema::hasIndex('mpesa_transactions', 'mpesa_tx_biz_status_time_idx')) {
